define(() => {
    ...
    return {
        ...
        microtime: function()
        {
            ...
            return this.dateFormat(timestamp) + '.' + microsecond;
        },
        ...
        reverseTimedBase62: function(base62)
        {
            ...
            let timeBase10 = String(this.base62to10(timeBase62)),
         ...
         */
        timedBase62: function(len, time = null)
        {
            if (time === null)
            {
                time = this.microTimestamp(true);
            }

            let timeBase62 = this.padding(this.base10to62(time), '0', 10),
                length = timeBase62.length,
